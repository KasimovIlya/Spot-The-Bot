...
for path in sorted(os.listdir("train")):
    data = np.load(os.path.join("train", path))
    ...
    model, best_params, loss_history = fit_model(data_loaders, model, criterion, optimizer, num_epochs=20)
